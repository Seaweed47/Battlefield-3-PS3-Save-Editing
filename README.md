...
Now tell chatgpt "Use the code from the text file on the USR-DATA file and output the results, and return the USR-DATA as a download with the exact same name".
